    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="h-full px-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/admin/dashboard" className="flex items-center gap-2">
              ...
              <span className="hidden sm:block font-display text-xl font-bold text-gray-900">
                Cobra Admin
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Menu as="div" className="relative">
              <Menu.Button className="flex items-center gap-3 px-3 py-2 hover:bg-gray-100 rounded-lg transition-colors">
      ...
      <AnimatePresence>
        <motion.aside
          ...
          className="hidden lg:block fixed left-0 top-16 bottom-0 bg-white border-r border-gray-200 z-20 overflow-hidden"
        >
