  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
          {/* Main Image */}
          <div className="aspect-square rounded-2xl bg-gray-200 dark:bg-gray-700 animate-pulse mb-4" />
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="text-center space-y-2">
                <div className="w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded-full mx-auto animate-pulse" />
      ...
      <div className="mt-12 space-y-6">
        <div className="flex gap-6 border-b dark:border-gray-700">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="h-10 bg-gray-200 dark:bg-gray-700 rounded w-24 animate-pulse" />
          ))}
        </div>
        <div className="space-y-2">
          {[...Array(5)].map((_, i) => (
